  ...
  if (ust){
    axios.post('http://39.104.62.62:5000/TraditionalPred', {
      ...
      if (ret.code){ // 错误
        ...
        //   return  JSON.parse(localStorage.getItem(name))//把本地存储的my转成数组
        // }
        save("ARIMAoYD15",oYD15)
        save("ARIMApYD15",pYD15);
        save("ARIMAdatatime",datatime)
          ...
          <div class="col-span-1 ">
            <div class="grid grid-cols-1">
              <div class="card p-fluid">
                ...
                <Button label="确认" @click="ARIMAPredict" />
              </div>
            </div>
          </div>
      </div>
